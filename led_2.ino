...
OSCErrorCode error;
IPAddress iplocal(192, 168, 0, 102); //elegir ip para el nodemcu LED2
...
const unsigned int puertoEntrada = 7002; //LED2
WiFiUDP Udp;
